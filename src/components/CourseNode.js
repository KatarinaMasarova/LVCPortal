...
class CourseNode extends React.Component {
  render() {
    return (
      <div className="container-90 main">
        <h3 className="course-h3">About NodeJS Course</h3>
        <div className="row">
          <div className="col-12 col-md-4">
            <img className="home-image" src={process.env.PUBLIC_URL + '/images/node.png'} alt="" />
          </div>
